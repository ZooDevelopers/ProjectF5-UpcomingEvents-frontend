...
<div class="fixed z-10 top-0 left-0 w-full h-full flex items-center justify-center">
    <div class="w-full max-w-[1080px] bg-white rounded-[20px] relative grid md:grid-cols-10 mx-4 md:mx-16">
        <div class="hidden md:flex w-full md:col-span-5 lg:col-span-6 bg-center bg-cover bg-no-repeat" :style="{ backgroundImage: `url(${modalBackgroundImage})` }">
            <!-- <img class="w-full" src="../../assets/events-form-img.jpg" /> -->
        </div>
        
        <div class="md:col-span-5 lg:col-span-4 px-10 py-[50px] bg-purple-700 flex-col justify-start items-start gap-10 inline-flex">
        ...
        <div class="w-10 h-10 right-5 top-5 flex items-center justify-center bg-purple-500 rounded-[20px] absolute cursor-pointer">
